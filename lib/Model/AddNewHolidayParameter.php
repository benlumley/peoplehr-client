...
/**
 * AddNewHolidayParameter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddNewHolidayParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNewHolidayParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee holiday to AddNewHoliday
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddNewHolidayParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = AddNewHoliday
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for add new holiday
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AddNewHolidayParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets duration_type
     *
     * @param string $duration_type Duration type for add new holiday
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date StartDate for add new holiday
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date End date for add new holiday
     *
     * @return self
     */
     ...
     *
     * @param int $duration_in_days Duration in days for add new holiday
     *
     * @return self
     */
     ...
     *
     * @param int $duration_in_minutes Duration in minutes for add new holiday
     *
     * @return self
     */
     ...
     * Sets part_of_day
     *
     * @param \OpenAPI\Client\Model\PartOfDay|null $part_of_day Part of day for add new holiday
     *
     * @return self
     */
     ...
     * Sets comments
     *
     * @param string|null $comments Comments for add new holiday
     *
     * @return self
     */
