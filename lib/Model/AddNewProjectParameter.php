...
/**
 * AddNewProjectParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class AddNewProjectParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNewProjectParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to add new project
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddNewProjectParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = AddNewProject
     *
     * @return self
     */
     ...
     * Sets project_name
     *
     * @param string $project_name ProjectName for add new project
     *
     * @return self
     */
     ...
     * Sets in_use
     *
     * @param string $in_use InUse for add new project
     *
     * @return self
     */
