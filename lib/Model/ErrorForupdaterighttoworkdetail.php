...
/**
 * ErrorForupdaterighttoworkdetail Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForupdaterighttoworkdetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForupdaterighttoworkdetail';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 7)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForupdaterighttoworkdetail., must be smaller than or equal to 7.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForupdaterighttoworkdetail., must be bigger than or equal to 0.');
        }
