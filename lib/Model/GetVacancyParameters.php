...
/**
 * GetVacancyParameters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetVacancyParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetVacancyParameters';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for vacancy api to get vacancy
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling GetVacancyParameters., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = GetVacancy
     *
     * @return self
     */
     ...
     *
     * @param string|null $vacancy_reference Vacancy reference for get vacancy
     *
     * @return self
     */
