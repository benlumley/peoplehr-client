...
/**
 * AddFilesForEmployeeVehicleUpdateArrayInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesForEmployeeVehicleUpdateArrayInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesForEmployeeVehicleUpdateArray_inner';
    ...
    */
     ...
     * Sets document_name
     *
     * @param string $document_name DocumentName to update employee's new vehicle detail
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description to updtae employee's new vehicle detail
     *
     * @return self
     */
     ...
     *
     * @param string $document_category DocumentCategory to update employee's new vehicle detail
     *
     * @return self
     */
     ...
     *
     * @param bool $signature_required SignatureRequired to update employee's new vehicle detail
     *
     * @return self
     */
