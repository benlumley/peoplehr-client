...
/**
 * ErrorForDeleteVehicleDetail Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForDeleteVehicleDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForDeleteVehicleDetail';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 9)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForDeleteVehicleDetail., must be smaller than or equal to 9.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForDeleteVehicleDetail., must be bigger than or equal to 0.');
        }
