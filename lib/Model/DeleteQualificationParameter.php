...
/**
 * DeleteQualificationParameter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteQualificationParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteQualificationParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for delete qualification
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteQualificationParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = DeleteQualification
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for delete qualification
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling DeleteQualificationParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param int $qualification_id QualificationId for delete qualification
     *
     * @return self
     */
