...
/**
 * Result3GetHistoryByEmployeeIdAndFieldNameInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class Result3GetHistoryByEmployeeIdAndFieldNameInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Result3GetHistoryByEmployeeIdAndFieldName_inner';
    ...
    */
     ...
     * Sets old_value
     *
     * @param string|null $old_value OldValue value
     *
     * @return self
     */
     ...
     * Sets new_value
     *
     * @param string|null $new_value NewValue value
     *
     * @return self
     */
