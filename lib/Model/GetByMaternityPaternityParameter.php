...
/**
 * GetByMaternityPaternityParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class GetByMaternityPaternityParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetByMaternityPaternityParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for get by maternity paternity
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling GetByMaternityPaternityParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = GetByMaternityPaternityId
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employeeid for get by maternity paternity
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling GetByMaternityPaternityParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param int $maternity_paternity_txn_id CPID for get by maternity paternity
     *
     * @return self
     */
