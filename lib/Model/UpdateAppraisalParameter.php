 ...
 */
class UpdateAppraisalParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAppraisalParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to UpdateAppraisal
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling UpdateAppraisalParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = UpdateAppraisal
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee Id for update appraisal
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling UpdateAppraisalParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param \DateTime $appraisal_review_date Appraisal review date  for update appraisal
     *
     * @return self
     */
     ...
     * Sets reviewer
     *
     * @param string $reviewer Reviewer for update appraisal
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string $notes Notes for update appraisal
     *
     * @return self
     */
     ...
     * Sets action_plan
     *
     * @param string $action_plan Action Plan for update appraisal
     *
     * @return self
     */
     ...
     * Sets objectives
     *
     * @param string $objectives Objectives for update appraisal
     *
     * @return self
     */
