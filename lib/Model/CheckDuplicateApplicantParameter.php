...
/**
 * CheckDuplicateApplicantParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class CheckDuplicateApplicantParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckDuplicateApplicantParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for applicant api to check duplicate applicant
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling CheckDuplicateApplicantParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = CheckDuplicateApplicant
     *
     * @return self
     */
     ...
     *
     * @param string|null $vacancy_reference Vacancy reference for check duplicate applicant
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string $first_name First name for check duplicate applicant
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CheckDuplicateApplicantParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name Last name for check duplicate applicant
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CheckDuplicateApplicantParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets email
     *
     * @param string|null $email Email for check duplicate applicant
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CheckDuplicateApplicantParameter., must be smaller than or equal to 254.');
        }
