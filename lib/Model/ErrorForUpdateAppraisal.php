...
/**
 * ErrorForUpdateAppraisal Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForUpdateAppraisal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForUpdateAppraisal';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 6)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForUpdateAppraisal., must be smaller than or equal to 6.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForUpdateAppraisal., must be bigger than or equal to 0.');
        }
