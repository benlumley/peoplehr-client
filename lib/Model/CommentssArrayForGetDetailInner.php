...
/**
 * CommentssArrayForGetDetailInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CommentssArrayForGetDetailInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommentssArrayForGetDetail_inner';
    ...
    */
     ...
     * Sets comment_id
     *
     * @param int|null $comment_id CommentId value
     *
     * @return self
     */
     ...
     * Sets posted_by
     *
     * @param string|null $posted_by PostedBy value
     *
     * @return self
     */
    public function setPostedBy($posted_by)
    {
        if (is_null($posted_by)) {
            throw new \InvalidArgumentException('non-nullable posted_by cannot be null');
        }
