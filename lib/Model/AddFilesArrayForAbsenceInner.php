...
/**
 * AddFilesArrayForAbsenceInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesArrayForAbsenceInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesArrayForAbsence_inner';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AddFilesArrayForAbsenceInner., must be smaller than or equal to 0.');
        }
