...
/**
 * ErrorForGetVehicleDetailByVehicleId Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForGetVehicleDetailByVehicleId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForGetVehicleDetailByVehicleId';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'int',
        'message' => 'string',
        'result' => '\OpenAPI\Client\Model\ResultGetVehicleDetailByVehicleIdObject'
    ];
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 10)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForGetVehicleDetailByVehicleId., must be smaller than or equal to 10.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForGetVehicleDetailByVehicleId., must be bigger than or equal to 0.');
        }
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\ResultGetVehicleDetailByVehicleIdObject|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\ResultGetVehicleDetailByVehicleIdObject|null $result Result value
     *
     * @return self
     */
