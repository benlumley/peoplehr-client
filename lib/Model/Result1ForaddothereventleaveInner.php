...
/**
 * Result1ForaddothereventleaveInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class Result1ForaddothereventleaveInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Result1Foraddothereventleave_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['descriptions']) && (mb_strlen($this->container['descriptions']) > 1024)) {
            $invalidProperties[] = "invalid value for 'descriptions', the character length must be smaller than or equal to 1024.";
        }
     ...
     * Sets document_name
     *
     * @param string $document_name Document Name Value
     *
     * @return self
     */
    ...
    public function setDescriptions($descriptions)
    {
        ...
        if ((mb_strlen($descriptions) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling Result1ForaddothereventleaveInner., must be smaller than or equal to 1024.');
        }
