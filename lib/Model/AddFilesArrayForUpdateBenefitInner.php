...
/**
 * AddFilesArrayForUpdateBenefitInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesArrayForUpdateBenefitInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesArrayForUpdateBenefit_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['document_name']) > 0)) {
            $invalidProperties[] = "invalid value for 'document_name', the character length must be smaller than or equal to 0.";
        }
        ...
        if (!is_null($this->container['description']) && (mb_strlen($this->container['description']) > 0)) {
            $invalidProperties[] = "invalid value for 'description', the character length must be smaller than or equal to 0.";
        }

        if ($this->container['document_category'] === null) {
            $invalidProperties[] = "'document_category' can't be null";
        }
        if ((mb_strlen($this->container['document_category']) > 0)) {
            $invalidProperties[] = "invalid value for 'document_category', the character length must be smaller than or equal to 0.";
        }
     ...
     * Sets document_name
     *
     * @param string $document_name DocumentName value
     *
     * @return self
     */
    public function setDocumentName($document_name)
    {
        ...
        if ((mb_strlen($document_name) > 0)) {
            throw new \InvalidArgumentException('invalid length for $document_name when calling AddFilesArrayForUpdateBenefitInner., must be smaller than or equal to 0.');
        }
     ...
     * Sets file
     *
     * @param string $file File base64 value
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AddFilesArrayForUpdateBenefitInner., must be smaller than or equal to 0.');
        }
     ...
     *
     * @param string $document_category Document category value
     *
     * @return self
     */
    public function setDocumentCategory($document_category)
    {
        ...
        if ((mb_strlen($document_category) > 0)) {
            throw new \InvalidArgumentException('invalid length for $document_category when calling AddFilesArrayForUpdateBenefitInner., must be smaller than or equal to 0.');
        }
     ...
     *
     * @param bool $signature_required Signature Required value
     *
     * @return self
     */
