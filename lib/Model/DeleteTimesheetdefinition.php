...
/**
 * DeleteTimesheetdefinition Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class DeleteTimesheetdefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteTimesheetdefinition';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for delete employee timesheet
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteTimesheetdefinition., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = DeleteTimesheet
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for delete employee timesheet
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling DeleteTimesheetdefinition., must be smaller than or equal to 15.');
        }
     ...
     * Sets timesheet_date
     *
     * @param \DateTime $timesheet_date Employee Timesheet Date to delete
     *
     * @return self
     */
