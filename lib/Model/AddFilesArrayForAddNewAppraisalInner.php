...
/**
 * AddFilesArrayForAddNewAppraisalInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesArrayForAddNewAppraisalInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesArrayForAddNewAppraisal_inner';
    ...
    */
    ...
    public function setDocumentName($document_name)
    {
        ...
        if ((mb_strlen($document_name) > 0)) {
            throw new \InvalidArgumentException('invalid length for $document_name when calling AddFilesArrayForAddNewAppraisalInner., must be smaller than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AddFilesArrayForAddNewAppraisalInner., must be smaller than or equal to 0.');
        }
    ...
    public function setDocumentCategory($document_category)
    {
        ...
        if ((mb_strlen($document_category) > 0)) {
            throw new \InvalidArgumentException('invalid length for $document_category when calling AddFilesArrayForAddNewAppraisalInner., must be smaller than or equal to 0.');
        }
