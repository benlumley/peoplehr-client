 ...
 */
class CheckAuthenticationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckAuthenticationResult';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 7)) {
            throw new \InvalidArgumentException('invalid value for $status when calling CheckAuthenticationResult., must be smaller than or equal to 7.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling CheckAuthenticationResult., must be bigger than or equal to 0.');
        }
