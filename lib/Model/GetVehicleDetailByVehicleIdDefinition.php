...
/**
 * GetVehicleDetailByVehicleIdDefinition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetVehicleDetailByVehicleIdDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetVehicleDetailByVehicleIdDefinition';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey to get employee's vehicle detail by vehicle id
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling GetVehicleDetailByVehicleIdDefinition., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = GetByVehicleDetailId
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id to get employee's vehicle detail
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling GetVehicleDetailByVehicleIdDefinition., must be smaller than or equal to 15.');
        }
     ...
     * Sets vehicle_id
     *
     * @param int $vehicle_id Vehicle Id to get employee's vehicle detail
     *
     * @return self
     */
