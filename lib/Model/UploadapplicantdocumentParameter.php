...
/**
 * UploadapplicantdocumentParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class UploadapplicantdocumentParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'uploadapplicantdocumentParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for Employee late api to upload applicant document
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling UploadapplicantdocumentParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = uploadapplicantdocument
     *
     * @return self
     */
     ...
     * Sets applicant_id
     *
     * @param int $applicant_id ApplicantId for upload applicant document
     *
     * @return self
     */
     ...
     * Sets document_name
     *
     * @param string $document_name Document name for upload applicant document
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description for upload applicant document
     *
     * @return self
     */
     ...
     * Sets file
     *
     * @param string $file File for upload applicant document
     *
     * @return self
     */
