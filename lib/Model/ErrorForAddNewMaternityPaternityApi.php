...
/**
 * ErrorForAddNewMaternityPaternityApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForAddNewMaternityPaternityApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForAddNewMaternityPaternityApi';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'int',
        'message' => 'string',
        'result' => '\OpenAPI\Client\Model\ResultMaternityPaternityTxnIdObject'
    ];
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 10)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForAddNewMaternityPaternityApi., must be smaller than or equal to 10.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForAddNewMaternityPaternityApi., must be bigger than or equal to 0.');
        }
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\ResultMaternityPaternityTxnIdObject|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\ResultMaternityPaternityTxnIdObject|null $result Result Value
     *
     * @return self
     */
