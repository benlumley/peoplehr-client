...
/**
 * AddFilesArrayForEmployeeCPDInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesArrayForEmployeeCPDInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesArrayForEmployeeCPD_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['file']) > 50)) {
            $invalidProperties[] = "invalid value for 'file', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setDocumentName($document_name)
    {
        ...
        if ((mb_strlen($document_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $document_name when calling AddFilesArrayForEmployeeCPDInner., must be smaller than or equal to 100.');
        }
    ...
    public function setFile($file)
    {
        ...
        if ((mb_strlen($file) > 50)) {
            throw new \InvalidArgumentException('invalid length for $file when calling AddFilesArrayForEmployeeCPDInner., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 256)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AddFilesArrayForEmployeeCPDInner., must be smaller than or equal to 256.');
        }
    ...
    public function setDocumentCategory($document_category)
    {
        ...
        if ((mb_strlen($document_category) > 100)) {
            throw new \InvalidArgumentException('invalid length for $document_category when calling AddFilesArrayForEmployeeCPDInner., must be smaller than or equal to 100.');
        }
