...
/**
 * DeleteMaternityPaternityParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class DeleteMaternityPaternityParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteMaternityPaternityParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to DeleteMaternityPaternity
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteMaternityPaternityParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = DeleteMaternityPaternity
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee Id value
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling DeleteMaternityPaternityParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param int $maternity_paternity_txn_id MaternityPaternityTxnId Value
     *
     * @return self
     */
