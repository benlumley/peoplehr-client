...
/**
 * ErrorForgetotherevententitlement Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForgetotherevententitlement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForgetotherevententitlement';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'int',
        'message' => 'string',
        'result' => '\OpenAPI\Client\Model\Result1ForgetotherevententitlementInner[]'
    ];
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 10)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForgetotherevententitlement., must be smaller than or equal to 10.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForgetotherevententitlement., must be bigger than or equal to 0.');
        }
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\Result1ForgetotherevententitlementInner[]|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\Result1ForgetotherevententitlementInner[]|null $result Result value
     *
     * @return self
     */
