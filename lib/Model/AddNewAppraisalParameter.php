 ...
 */
class AddNewAppraisalParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNewAppraisalParameter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appraisal_review_date'] === null) {
            $invalidProperties[] = "'appraisal_review_date' can't be null";
        }
        ...
        if ($this->container['action_plan'] === null) {
            $invalidProperties[] = "'action_plan' can't be null";
        }
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to AddNewAppraisal
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddNewAppraisalParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = AddNewAppraisal
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for add new appraisal
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AddNewAppraisalParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param \DateTime $appraisal_review_date Appraisal review date for add new appraisal
     *
     * @return self
     */
     ...
     * Sets reviewer
     *
     * @param string $reviewer Reviewer for add new appraisal
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string $notes Notes for add new appraisal
     *
     * @return self
     */
     ...
     * Sets action_plan
     *
     * @param string $action_plan Action Plan for add new appraisal
     *
     * @return self
     */
     ...
     * Sets objectives
     *
     * @param string $objectives Objectives for add new appraisal
     *
     * @return self
     */
