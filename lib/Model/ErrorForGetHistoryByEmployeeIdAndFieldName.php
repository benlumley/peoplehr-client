 ...
 */
class ErrorForGetHistoryByEmployeeIdAndFieldName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForGetHistoryByEmployeeIdAndFieldName';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('result_1', $data ?? [], null);
        $this->setIfExists('result_2', $data ?? [], null);
        $this->setIfExists('result_3', $data ?? [], null);
    }
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 9)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForGetHistoryByEmployeeIdAndFieldName., must be smaller than or equal to 9.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForGetHistoryByEmployeeIdAndFieldName., must be bigger than or equal to 0.');
        }
     ...
     * Sets message
     *
     * @param string|null $message Message show as per error code
     *
     * @return self
     */
    ...
    {
        return $this->container['result_1'];
    }
     ...
     * @return self
     */
    public function setResult1($result_1)
    {
        if (is_null($result_1)) {
            throw new \InvalidArgumentException('non-nullable result_1 cannot be null');
        }
        $this->container['result_1'] = $result_1;
    ...
    {
        return $this->container['result_2'];
    }
     ...
     * @return self
     */
    public function setResult2($result_2)
    {
        if (is_null($result_2)) {
            throw new \InvalidArgumentException('non-nullable result_2 cannot be null');
        }
        $this->container['result_2'] = $result_2;
    ...
    {
        return $this->container['result_3'];
    }
     ...
     * @return self
     */
    public function setResult3($result_3)
    {
        if (is_null($result_3)) {
            throw new \InvalidArgumentException('non-nullable result_3 cannot be null');
        }
        $this->container['result_3'] = $result_3;
