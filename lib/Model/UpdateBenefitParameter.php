 ...
 */
class UpdateBenefitParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateBenefitParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to UpdateBenefit
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling UpdateBenefitParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = UpdateBenefit
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee Id for update benefit
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling UpdateBenefitParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets benefit
     *
     * @param string $benefit Benefit for update benefit
     *
     * @return self
     */
     ...
     * Sets benefit_id
     *
     * @param int $benefit_id Benefit id for update benefit
     *
     * @return self
     */
     ...
     * Sets date_awarded
     *
     * @param \DateTime $date_awarded DateAwarded for update benefit
     *
     * @return self
     */
     ...
     * Sets expiry_date
     *
     * @param \DateTime|null $expiry_date ExpiryDate for update benefit
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value Value for update benefit
     *
     * @return self
     */
