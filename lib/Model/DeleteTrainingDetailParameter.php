...
/**
 * DeleteTrainingDetailParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class DeleteTrainingDetailParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteTrainingDetailParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for delete training detail
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteTrainingDetailParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = deletetrainingdetail
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for delete training detail
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling DeleteTrainingDetailParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets training_id
     *
     * @param int $training_id Training Id for delete training detail
     *
     * @return self
     */
