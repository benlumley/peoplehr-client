...
/**
 * GetByCPDIdParameter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetByCPDIdParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetByCPDIdParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for get by cpd id
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling GetByCPDIdParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = GetByCPDId
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employeeid for get by cpd id
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling GetByCPDIdParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets cpdid
     *
     * @param int $cpdid CPID for get by cpd id
     *
     * @return self
     */
