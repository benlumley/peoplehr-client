 ...
 */
class AddTrainingDetailParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddTrainingDetailParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for add training detail
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddTrainingDetailParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = AddTrainingDetail
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for add training detail
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AddTrainingDetailParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets training_type
     *
     * @param string $training_type Training type for add training detail
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Description for add training detail
     *
     * @return self
     */
     ...
     * Sets importance
     *
     * @param int $importance Importance for add training detail
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int $status Status for add training detail
     *
     * @return self
     */
     ...
     * Sets in_progress
     *
     * @param string|null $in_progress InProgress for add training detail
     *
     * @return self
     */
     ...
     * Sets training_date
     *
     * @param \DateTime|null $training_date Training date for add training detail
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $trainind_end_date Training end date for add training detail
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $training_expiry_date Training expiry date for add training detail
     *
     * @return self
     */
     ...
     * Sets cost
     *
     * @param float|null $cost Cost for add training detail
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param string|null $provider Provider for add training detail
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string|null $notes Notes for add training detail
     *
     * @return self
     */
