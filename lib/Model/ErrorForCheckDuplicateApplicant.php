...
/**
 * ErrorForCheckDuplicateApplicant Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForCheckDuplicateApplicant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForCheckDuplicateApplicant';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'int',
        'message' => 'string',
        'result' => '\OpenAPI\Client\Model\ResultCheckDuplicateApplicant'
    ];
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 9)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForCheckDuplicateApplicant., must be smaller than or equal to 9.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForCheckDuplicateApplicant., must be bigger than or equal to 0.');
        }
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\ResultCheckDuplicateApplicant|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\ResultCheckDuplicateApplicant|null $result Result value
     *
     * @return self
     */
