...
/**
 * AddFilesForEmployeeDrivingInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesForEmployeeDrivingInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesForEmployeeDriving_inner';
    ...
    */
     ...
     * Sets document_name
     *
     * @param string $document_name DocumentName for employee driving
     *
     * @return self
     */
    public function setDocumentName($document_name)
    {
        ...
        if ((mb_strlen($document_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $document_name when calling AddFilesForEmployeeDrivingInner., must be smaller than or equal to 100.');
        }
     ...
     * Sets file
     *
     * @param string $file File for employee driving
     *
     * @return self
     */
     ...
     * Sets descriptions
     *
     * @param string|null $descriptions Descriptions for employee driving
     *
     * @return self
     */
    public function setDescriptions($descriptions)
    {
        ...
        if ((mb_strlen($descriptions) > 256)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling AddFilesForEmployeeDrivingInner., must be smaller than or equal to 256.');
        }
     ...
     *
     * @param string $document_category DocumentCategory for employee driving
     *
     * @return self
     */
    public function setDocumentCategory($document_category)
    {
        ...
        if ((mb_strlen($document_category) > 100)) {
            throw new \InvalidArgumentException('invalid length for $document_category when calling AddFilesForEmployeeDrivingInner., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param bool $signature_required SignatureRequired for employee driving
     *
     * @return self
     */
