...
/**
 * DeleteAppraisalParameter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteAppraisalParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteAppraisalParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to DeleteAppraisal
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteAppraisalParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = DeleteAppraisal
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee Id for delete appraisal
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling DeleteAppraisalParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets appraisal_id
     *
     * @param int $appraisal_id Appraisal Id for delete appraisal
     *
     * @return self
     */
