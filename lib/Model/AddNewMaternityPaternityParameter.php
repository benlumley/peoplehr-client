...
/**
 * AddNewMaternityPaternityParameter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddNewMaternityPaternityParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNewMaternityPaternityParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to AddNewMaternityPaternity
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddNewMaternityPaternityParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = AddNewMaternityPaternity
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee Id for add new maternity paternity
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AddNewMaternityPaternityParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets due_date
     *
     * @param \DateTime $due_date DueDate for add new maternity paternity
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $actual_start_date Actual Start Date for add new maternity paternity
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $actual_end_date Actual End Date for add new maternity paternity
     *
     * @return self
     */
     ...
     * Sets add_comments
     *
     * @param \OpenAPI\Client\Model\AddCommentsArrayForMaternityPaternityInner[] $add_comments AddComments value
     *
     * @return self
     */
