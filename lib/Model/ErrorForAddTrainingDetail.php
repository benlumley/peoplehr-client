...
/**
 * ErrorForAddTrainingDetail Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForAddTrainingDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForAddTrainingDetail';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 9)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForAddTrainingDetail., must be smaller than or equal to 9.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForAddTrainingDetail., must be bigger than or equal to 0.');
        }
