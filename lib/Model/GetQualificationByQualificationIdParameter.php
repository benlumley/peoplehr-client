...
/**
 * GetQualificationByQualificationIdParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class GetQualificationByQualificationIdParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQualificationByQualificationIdParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIkey for get qualification by qualificationId
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling GetQualificationByQualificationIdParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = GetQualificationByQualificationId
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id EmployeeId for get qualification by qualificationId
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling GetQualificationByQualificationIdParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param int $qualification_id QualificationId for get qualification by qualificationId
     *
     * @return self
     */
