 ...
 */
class AddNewCustomScreenTransactionParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNewCustomScreenTransactionParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee custom screen api to AddNewCustomScreenTransaction
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddNewCustomScreenTransactionParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = AddNewCustomScreenTransaction
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id EmployeeId for add new custom screen transaction
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AddNewCustomScreenTransactionParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets screen_id
     *
     * @param int $screen_id ScreenId for add new custom screen transaction
     *
     * @return self
     */
