...
class UpdateTrainingDetailParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets custom_columns
     *
     * @param \OpenAPI\Client\Model\CustomColumnsForEmployeeTrainingInner[]|null $custom_columns Custom columns for update training detail
     *
     * @return self
     */
     ...
     * Sets add_files
     *
     * @param \OpenAPI\Client\Model\AddFilesForEmployeeTrainingInner[]|null $add_files Add files for update training detail
     *
     * @return self
     */
