...
/**
 * ErrorFordeletetrainingdetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorFordeletetrainingdetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorFordeletetrainingdetail';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 9)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorFordeletetrainingdetail., must be smaller than or equal to 9.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorFordeletetrainingdetail., must be bigger than or equal to 0.');
        }
