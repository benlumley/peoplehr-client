...
/**
 * CustomColumnsForEmployeeVehicleUpdateArrayInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomColumnsForEmployeeVehicleUpdateArrayInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomColumnsForEmployeeVehicleUpdateArray_inner';
    ...
    */
     ...
     * Sets column_name
     *
     * @param string $column_name ColumnName to update employee's new vehicle detail
     *
     * @return self
     */
     ...
     * Sets column_value
     *
     * @param string|null $column_value ColumnValue to update employee's new vehicle detail
     *
     * @return self
     */
