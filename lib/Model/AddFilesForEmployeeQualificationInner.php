...
/**
 * AddFilesForEmployeeQualificationInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddFilesForEmployeeQualificationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFilesForEmployeeQualification_inner';
    ...
    public const SIGNATURE_REQUIRED_FALSE = 'false';
    public const SIGNATURE_REQUIRED_TRUE = 'true';
     ...
     * @return string[]
     */
    public function getSignatureRequiredAllowableValues()
    {
        return [
            self::SIGNATURE_REQUIRED_FALSE,
            self::SIGNATURE_REQUIRED_TRUE,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['descriptions']) && (mb_strlen($this->container['descriptions']) > 256)) {
            $invalidProperties[] = "invalid value for 'descriptions', the character length must be smaller than or equal to 256.";
        }
        ...
        $allowedValues = $this->getSignatureRequiredAllowableValues();
        if (!is_null($this->container['signature_required']) && !in_array($this->container['signature_required'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'signature_required', must be one of '%s'",
                $this->container['signature_required'],
     ...
     * Sets document_name
     *
     * @param string $document_name DocumentName for employee qualification
     *
     * @return self
     */
    public function setDocumentName($document_name)
    {
        ...
        if ((mb_strlen($document_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $document_name when calling AddFilesForEmployeeQualificationInner., must be smaller than or equal to 100.');
        }
     ...
     * Sets file
     *
     * @param string $file File for employee qualification
     *
     * @return self
     */
     ...
     * Sets descriptions
     *
     * @param string|null $descriptions Descriptions for employee qualification
     *
     * @return self
     */
    public function setDescriptions($descriptions)
    {
        ...
        if ((mb_strlen($descriptions) > 256)) {
            throw new \InvalidArgumentException('invalid length for $descriptions when calling AddFilesForEmployeeQualificationInner., must be smaller than or equal to 256.');
        }
     ...
     *
     * @param string $document_category DocumentCategory for employee qualification
     *
     * @return self
     */
    public function setDocumentCategory($document_category)
    {
        ...
        if ((mb_strlen($document_category) > 100)) {
            throw new \InvalidArgumentException('invalid length for $document_category when calling AddFilesForEmployeeQualificationInner., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param bool $signature_required SignatureRequired for employee qualification
     *
     * @return self
     */
    public function setSignatureRequired($signature_required)
    {
        ...
        $allowedValues = $this->getSignatureRequiredAllowableValues();
        if (!in_array($signature_required, $allowedValues, true)) {
