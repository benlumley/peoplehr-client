 ...
 */
class WeekArrayForWorkPatternInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeekArrayForWorkPattern_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('week_detail', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['week_detail'];
    }
     ...
     * @return self
     */
    public function setWeekDetail($week_detail)
    {
        if (is_null($week_detail)) {
            throw new \InvalidArgumentException('non-nullable week_detail cannot be null');
        }
        $this->container['week_detail'] = $week_detail;
