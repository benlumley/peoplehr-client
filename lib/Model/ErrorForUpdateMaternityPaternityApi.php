...
/**
 * ErrorForUpdateMaternityPaternityApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForUpdateMaternityPaternityApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForUpdateMaternityPaternityApi';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 10)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForUpdateMaternityPaternityApi., must be smaller than or equal to 10.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForUpdateMaternityPaternityApi., must be bigger than or equal to 0.');
        }
