...
/**
 * CustomColumnsForEmployeeVehicleAddArrayInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomColumnsForEmployeeVehicleAddArrayInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomColumnsForEmployeeVehicleAddArray_inner';
    ...
    */
     ...
     * Sets column_name
     *
     * @param string $column_name ColumnName to add employee's new vehicle detail
     *
     * @return self
     */
     ...
     * Sets column_value
     *
     * @param string|null $column_value ColumnValue to add employee's new vehicle detail
     *
     * @return self
     */
