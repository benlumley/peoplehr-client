...
/**
 * ResultlstInternalQuestionsInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class ResultlstInternalQuestionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResultlstInternalQuestions_inner';
    ...
    */
     ...
     *
     * @param string|null $question_options QuestionOptions value
     *
     * @return self
     */
