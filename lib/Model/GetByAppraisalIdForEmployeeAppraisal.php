...
/**
 * GetByAppraisalIdForEmployeeAppraisal Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class GetByAppraisalIdForEmployeeAppraisal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetByAppraisalIdForEmployeeAppraisal';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appraisal_id'] === null) {
            $invalidProperties[] = "'appraisal_id' can't be null";
        }
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for employee api to GetByAppraisalId
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling GetByAppraisalIdForEmployeeAppraisal., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = GetByAppraisalId
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for get by appraisal id
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling GetByAppraisalIdForEmployeeAppraisal., must be smaller than or equal to 15.');
        }
     ...
     * Sets appraisal_id
     *
     * @param int $appraisal_id Appraisal id for get by appraisal id
     *
     * @return self
     */
