 ...
 */
class UpdateVehicleDetailDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateVehicleDetailDefinition';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey to update employee vehicle detail
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling UpdateVehicleDetailDefinition., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = UpdateVehicleDetail
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id to update employee's vehicle detail
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling UpdateVehicleDetailDefinition., must be smaller than or equal to 15.');
        }
     ...
     * Sets registration
     *
     * @param string $registration Registration to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets make
     *
     * @param string|null $make Make to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets model
     *
     * @param string|null $model Model to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets colour
     *
     * @param string|null $colour Colour to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets engine_size
     *
     * @param string|null $engine_size EngineSize to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets fuel_type
     *
     * @param string|null $fuel_type FuelType to update employee's vehicle detail
     *
     * @return self
     */
     ...
     *
     * @param string|null $insurance_company InsuranceCompany to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets policy_number
     *
     * @param string|null $policy_number PolicyNumber to update employee's vehicle detail
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $mot_expiry_date MOTExpiryDate to update employee's vehicle detail
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $insurance_expiry_date InsuranceExpiryDate to update employee's vehicle detail
     *
     * @return self
     */
     ...
     * Sets comments
     *
     * @param string|null $comments Comments to update employee's vehicle detail
     *
     * @return self
     */
