...
/**
 * DeductionsArrayInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeductionsArrayInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeductionsArray_inner';
    ...
    */
     ...
     * Sets deduction
     *
     * @param string $deduction Deduction value
     *
     * @return self
     */
    ...
    public function setComments($comments)
    {
        ...
        if ((mb_strlen($comments) > 0)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling DeductionsArrayInner., must be smaller than or equal to 0.');
        }
