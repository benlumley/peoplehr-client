...
/**
 * ResultCreateNewApplicant Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResultCreateNewApplicant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResultCreateNewApplicant';
    ...
    {
        $this->setIfExists('is_duplicate', $data ?? [], null);
    ...
    */
     ...
     * Sets is_duplicate
     *
     * @param bool|null $is_duplicate Is duplicate value
     *
     * @return self
     */
    public function setIsDuplicate($is_duplicate)
    {
        if (is_null($is_duplicate)) {
            throw new \InvalidArgumentException('non-nullable is_duplicate cannot be null');
        }
     ...
     * Sets applicant_id
     *
     * @param int|null $applicant_id ApplicantId value
     *
     * @return self
     */
