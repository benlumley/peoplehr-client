...
/**
 * AddNewRightToWorkDetailParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class AddNewRightToWorkDetailParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNewRightToWorkDetailParameter';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for right to work  api to addrighttoworkdetail
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AddNewRightToWorkDetailParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = addrighttoworkdetail
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for add right to work detail
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AddNewRightToWorkDetailParameter., must be smaller than or equal to 15.');
        }
     ...
     * Sets document_type
     *
     * @param string|null $document_type Document type for add right to work detail
     *
     * @return self
     */
     ...
     * Sets document_id
     *
     * @param float|null $document_id Document Id for add right to work detail
     *
     * @return self
     */
     ...
     * Sets valid_from
     *
     * @param \DateTime|null $valid_from Valid From for add right to work detail
     *
     * @return self
     */
     ...
     * Sets valid_to
     *
     * @param \DateTime|null $valid_to Valid To for add right to work detail
     *
     * @return self
     */
     ...
     * Sets duration
     *
     * @param int|null $duration Duration for add right to work detail
     *
     * @return self
     */
     ...
     * Sets document_name
     *
     * @param string $document_name Duration for add right to work detail
     *
     * @return self
     */
     ...
     * Sets file
     *
     * @param string $file File for add right to work detail
     *
     * @return self
     */
     ...
     * Sets comments
     *
     * @param string|null $comments Comments for add right to work detail
     *
     * @return self
     */
