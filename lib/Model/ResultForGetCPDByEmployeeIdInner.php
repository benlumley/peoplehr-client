 ...
 */
class ResultForGetCPDByEmployeeIdInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResultForGetCPDByEmployeeId_inner';
