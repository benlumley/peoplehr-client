...
/**
 * ArrayForGetByAppraisalIdArrayInner Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class ArrayForGetByAppraisalIdArrayInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArrayForGetByAppraisalIdArray_inner';
    ...
    */
     ...
     * Sets column_value
     *
     * @param string|null $column_value Column Value
     *
     * @return self
     */
