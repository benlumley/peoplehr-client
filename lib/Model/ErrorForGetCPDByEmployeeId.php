...
/**
 * ErrorForGetCPDByEmployeeId Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorForGetCPDByEmployeeId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorForGetCPDByEmployeeId';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'int',
        'message' => 'string',
        'result' => '\OpenAPI\Client\Model\ResultForGetCPDByEmployeeIdInner[]'
    ];
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status > 10)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForGetCPDByEmployeeId., must be smaller than or equal to 10.');
        }
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorForGetCPDByEmployeeId., must be bigger than or equal to 0.');
        }
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\ResultForGetCPDByEmployeeIdInner[]|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\ResultForGetCPDByEmployeeIdInner[]|null $result Result value
     *
     * @return self
     */
