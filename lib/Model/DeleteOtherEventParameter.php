...
/**
 * DeleteOtherEventParameter Class Doc Comment
 *
 * @category Class
 * @package  PeopleHR
 * @author   OpenAPI Generator team
 ...
 */
class DeleteOtherEventParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteOtherEventParameter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['other_leave_txn_id'] === null) {
            $invalidProperties[] = "'other_leave_txn_id' can't be null";
        }
     ...
     * Sets api_key
     *
     * @param string $api_key APIKey for other event api to DeleteOtherEvent
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteOtherEventParameter., must be smaller than or equal to 50.');
        }
     ...
     * Sets action
     *
     * @param string $action Action name = DeleteOtherEvent
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id Employee id for Delete Other Event
     *
     * @return self
     */
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling DeleteOtherEventParameter., must be smaller than or equal to 15.');
        }
     ...
     *
     * @param int $other_leave_txn_id Other Leave Txn Id for Delete Other Event
     *
     * @return self
     */
