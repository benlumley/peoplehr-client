...
class WorkPatternApi
{
    ...
    /**
     * Operation workPatternGetWorkPatternDetailPost
     *
    ...
    {
        list($response) = $this->workPatternGetWorkPatternDetailPostWithHttpInfo($body, $contentType);
        return $response;
    }

    /**
     * Operation workPatternGetWorkPatternDetailPostWithHttpInfo
     *
     * Get work pattern detail
     *
    ...
    /**
     * Operation workPatternGetWorkPatternDetailPostAsync
     *
     * Get work pattern detail
     *
     * @param  \OpenAPI\Client\Model\WorkPatternParameter $body (required)
     ...
     */
    public function workPatternGetWorkPatternDetailPostAsync($body, string $contentType = self::contentTypes['workPatternGetWorkPatternDetailPost'][0])
    {
        return $this->workPatternGetWorkPatternDetailPostAsyncWithHttpInfo($body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation workPatternGetWorkPatternDetailPostAsyncWithHttpInfo
     *
     * Get work pattern detail
     *
     * @param  \OpenAPI\Client\Model\WorkPatternParameter $body (required)
     ...
     */
    public function workPatternGetWorkPatternDetailPostRequest($body, string $contentType = self::contentTypes['workPatternGetWorkPatternDetailPost'][0])
    {

        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling workPatternGetWorkPatternDetailPost'
            );
        }


        $resourcePath = '/WorkPattern  -  GetWorkPatternDetail';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
