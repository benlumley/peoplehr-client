...
class EmailTransactionApi
{
    ...
    /**
     * Operation emailTransactionEmailInboxPost
     *
     * Email Inbox
     *
    ...
    {
        list($response) = $this->emailTransactionEmailInboxPostWithHttpInfo($body, $contentType);
        return $response;
    }

    /**
     * Operation emailTransactionEmailInboxPostWithHttpInfo
     *
     * Email Inbox
     *
    ...
    /**
     * Operation emailTransactionEmailInboxPostAsync
     *
     * Email Inbox
     *
     * @param  \OpenAPI\Client\Model\EmailInboxParameter $body (required)
     ...
     */
    public function emailTransactionEmailInboxPostAsync($body, string $contentType = self::contentTypes['emailTransactionEmailInboxPost'][0])
    {
        return $this->emailTransactionEmailInboxPostAsyncWithHttpInfo($body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation emailTransactionEmailInboxPostAsyncWithHttpInfo
     *
     * Email Inbox
     *
     * @param  \OpenAPI\Client\Model\EmailInboxParameter $body (required)
     ...
     */
    public function emailTransactionEmailInboxPostRequest($body, string $contentType = self::contentTypes['emailTransactionEmailInboxPost'][0])
    {

        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling emailTransactionEmailInboxPost'
            );
        }


        $resourcePath = '/Email Transaction  -  EmailInbox';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
