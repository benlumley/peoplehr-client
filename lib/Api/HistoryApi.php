...
class HistoryApi
{
    ...
    /**
     * Operation historyGetHistoryByEmployeeIdAndFieldNamePost
     *
    ...
    {
        list($response) = $this->historyGetHistoryByEmployeeIdAndFieldNamePostWithHttpInfo($body, $contentType);
        return $response;
    }

    /**
     * Operation historyGetHistoryByEmployeeIdAndFieldNamePostWithHttpInfo
     *
     * Get History By EmployeeId And FieldName
     *
    ...
    /**
     * Operation historyGetHistoryByEmployeeIdAndFieldNamePostAsync
     *
     * Get History By EmployeeId And FieldName
     *
     * @param  \OpenAPI\Client\Model\GetHistoryByEmployeeIdAndFieldNameParameter $body (required)
     ...
     */
    public function historyGetHistoryByEmployeeIdAndFieldNamePostAsync($body, string $contentType = self::contentTypes['historyGetHistoryByEmployeeIdAndFieldNamePost'][0])
    {
        return $this->historyGetHistoryByEmployeeIdAndFieldNamePostAsyncWithHttpInfo($body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation historyGetHistoryByEmployeeIdAndFieldNamePostAsyncWithHttpInfo
     *
     * Get History By EmployeeId And FieldName
     *
     * @param  \OpenAPI\Client\Model\GetHistoryByEmployeeIdAndFieldNameParameter $body (required)
     ...
     */
    public function historyGetHistoryByEmployeeIdAndFieldNamePostRequest($body, string $contentType = self::contentTypes['historyGetHistoryByEmployeeIdAndFieldNamePost'][0])
    {

        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling historyGetHistoryByEmployeeIdAndFieldNamePost'
            );
        }


        $resourcePath = '/History  -  GetHistoryByEmployeeIdAndFieldName';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
